...
class _ChatbotPageState extends State<ChatbotPage> {
  ...
  void initState() {
    super.initState();
    _addBotMessage("Hello! I'm Marine Guard's assistant. How can I help you today?");
    _showMainMenu();
  }
  ...
  void _handleSubmitted(String text) {
    ...
    if (text.length == 1 && RegExp(r'[1-5]').hasMatch(text)) {
      ...
      if (text == "1") {
        setState(() {
          _messages.add(ChatMessage(
            ...
            isUser: false,
            timestamp: DateTime.now(),
            widgets: ChatbotService.getComplaintMenuButtons(_handleOptionSelected),
          ));
        });
      } else if (text == "2") {
        setState(() {
      ...
      _addBotMessage("Please select an option from the menu or type a number between 1-5.");
      _showMainMenu();
    }
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: const Color(0xFF48A7FF).withOpacity(0.3),
                              blurRadius: 8,
                              offset: const Offset(0, 2),
                            ),
                          ],
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(
            child: message.widget ?? Container(
